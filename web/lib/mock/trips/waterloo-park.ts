 ...
 * trailing behind. This is the DEEP one — full transcripts, 7–8 tracks per
 * moment, and all three splat states. The other five trips are postcards by
 * comparison, deliberately.
 *
 * Its RNG seeds are PINNED to the literals its detections were originally
 * generated with. scripts/verify-pipeline.ts asserts a dozen specific facts about
...
export const waterlooPark: TripSpec = {
  id: TRIP_ID,
  title: "Waterloo Park loop",
  startedAt: "2026-08-02T15:10:00-04:00",
