...
/**
 * The app is one screen: the day as a full-screen map, with every kept moment
 * pinned as a Gaussian splat you can step inside. Everything is composed here
 * on the server so the client gets exactly the shapes it renders — full
 * moments for the takeover, the thinned path for the map, the object index
