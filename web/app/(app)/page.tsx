...
export const metadata = {
  title: "Spark — it walked with you",
  description: "A companion that decides for itself which minutes were worth keeping.",
};
...
export default function HomePage() {
  ...
  // listTrips() is newest-first, so the hero's stat line describes the most
  // recent real walk rather than a hardcoded slogan.
  const latest = trips[0];

  return (
    <main data-hero className="flex-1">
      <LandingHero latest={latest} />
